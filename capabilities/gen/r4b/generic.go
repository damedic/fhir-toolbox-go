...
func (w Generic) capabilityBase(ctx context.Context) (r4b.CapabilityStatement, error) {
	if gen, ok := w.Concrete.(capabilities.GenericCapabilities); ok {
		...
		r4cs, ok := cs.(r4b.CapabilityStatement)
		if !ok {
			return r4b.CapabilityStatement{}, fmt.Errorf("expected R4B.CapabilityStatement, got %T", cs)
		}
		return r4cs, nil
	}
	if cc, ok := w.Concrete.(capabilities.ConcreteCapabilities[r4b.CapabilityStatement]); ok {
		return cc.CapabilityBase(ctx)
	}
	return r4b.CapabilityStatement{}, fmt.Errorf("backend implements neither GenericCapabilities nor ConcreteCapabilities for R4B")
}
func (w Generic) CapabilityStatement(ctx context.Context) (model.CapabilityStatement, error) {
	...
	addSearchParam := func(r r4b.CapabilityStatementRestResource, param r4b.CapabilityStatementRestResourceSearchParam) r4b.CapabilityStatementRestResource {
	...
	addSearchInclude := func(r r4b.CapabilityStatementRestResource, include string) r4b.CapabilityStatementRestResource {
	...
	if c, ok := w.Concrete.(AccountSearch); ok {
		...
		if err != nil {
			...
			for n, p := range c.Parameters {
				...
				r = addSearchParam(r, r4b.CapabilityStatementRestResourceSearchParam{
	...
	if _, ok := w.Concrete.(SearchParameterSearch); !ok {
		...
		spResource = addSearchParam(spResource, r4b.CapabilityStatementRestResourceSearchParam{
