...
func (w Generic) capabilityBase(ctx context.Context) (r4.CapabilityStatement, error) {
	if gen, ok := w.Concrete.(capabilities.GenericCapabilities); ok {
		...
		if !ok {
			return r4.CapabilityStatement{}, fmt.Errorf("expected R4.CapabilityStatement, got %T", cs)
		}
		return r4cs, nil
	}
	if cc, ok := w.Concrete.(capabilities.ConcreteCapabilities[r4.CapabilityStatement]); ok {
		return cc.CapabilityBase(ctx)
	}
	return r4.CapabilityStatement{}, fmt.Errorf("backend implements neither GenericCapabilities nor ConcreteCapabilities for R4")
}
func (w Generic) CapabilityStatement(ctx context.Context) (model.CapabilityStatement, error) {
	...
	addSearchParam := func(r r4.CapabilityStatementRestResource, param r4.CapabilityStatementRestResourceSearchParam) r4.CapabilityStatementRestResource {
	...
	addSearchInclude := func(r r4.CapabilityStatementRestResource, include string) r4.CapabilityStatementRestResource {
	...
	if c, ok := w.Concrete.(AccountSearch); ok {
		...
		if err != nil {
			...
			for n, p := range c.Parameters {
				...
				r = addSearchParam(r, r4.CapabilityStatementRestResourceSearchParam{
	...
	if _, ok := w.Concrete.(SearchParameterSearch); !ok {
		...
		spResource = addSearchParam(spResource, r4.CapabilityStatementRestResourceSearchParam{
...
func (w Generic) Create(ctx context.Context, resource model.Resource) (model.Resource, error) {
	...
	case r4.EffectEvidenceSynthesis:
		if impl, ok := w.Concrete.(EffectEvidenceSynthesisCreate); ok {
	...
	case r4.MedicinalProduct:
		if impl, ok := w.Concrete.(MedicinalProductCreate); ok {
	...
	case r4.MedicinalProductAuthorization:
		if impl, ok := w.Concrete.(MedicinalProductAuthorizationCreate); ok {
	...
	case r4.MedicinalProductContraindication:
		if impl, ok := w.Concrete.(MedicinalProductContraindicationCreate); ok {
	...
	case r4.MedicinalProductIndication:
		if impl, ok := w.Concrete.(MedicinalProductIndicationCreate); ok {
	...
	case r4.MedicinalProductIngredient:
		if impl, ok := w.Concrete.(MedicinalProductIngredientCreate); ok {
	...
	case r4.MedicinalProductInteraction:
		if impl, ok := w.Concrete.(MedicinalProductInteractionCreate); ok {
	...
	case r4.MedicinalProductManufactured:
		if impl, ok := w.Concrete.(MedicinalProductManufacturedCreate); ok {
	...
	case r4.MedicinalProductPackaged:
		if impl, ok := w.Concrete.(MedicinalProductPackagedCreate); ok {
	...
	case r4.MedicinalProductPharmaceutical:
		if impl, ok := w.Concrete.(MedicinalProductPharmaceuticalCreate); ok {
	...
	case r4.MedicinalProductUndesirableEffect:
		if impl, ok := w.Concrete.(MedicinalProductUndesirableEffectCreate); ok {
	...
	case r4.RiskEvidenceSynthesis:
		if impl, ok := w.Concrete.(RiskEvidenceSynthesisCreate); ok {
	...
	case r4.SubstanceSpecification:
		if impl, ok := w.Concrete.(SubstanceSpecificationCreate); ok {
...
func (w Generic) Read(ctx context.Context, resourceType string, id string) (model.Resource, error) {
	...
	case "EffectEvidenceSynthesis":
		if impl, ok := w.Concrete.(EffectEvidenceSynthesisRead); ok {
	...
	case "MedicinalProduct":
		if impl, ok := w.Concrete.(MedicinalProductRead); ok {
	...
	case "MedicinalProductAuthorization":
		if impl, ok := w.Concrete.(MedicinalProductAuthorizationRead); ok {
	...
	case "MedicinalProductContraindication":
		if impl, ok := w.Concrete.(MedicinalProductContraindicationRead); ok {
	...
	case "MedicinalProductIndication":
		if impl, ok := w.Concrete.(MedicinalProductIndicationRead); ok {
	...
	case "MedicinalProductIngredient":
		if impl, ok := w.Concrete.(MedicinalProductIngredientRead); ok {
	...
	case "MedicinalProductInteraction":
		if impl, ok := w.Concrete.(MedicinalProductInteractionRead); ok {
	...
	case "MedicinalProductManufactured":
		if impl, ok := w.Concrete.(MedicinalProductManufacturedRead); ok {
	...
	case "MedicinalProductPackaged":
		if impl, ok := w.Concrete.(MedicinalProductPackagedRead); ok {
	...
	case "MedicinalProductPharmaceutical":
		if impl, ok := w.Concrete.(MedicinalProductPharmaceuticalRead); ok {
	...
	case "MedicinalProductUndesirableEffect":
		if impl, ok := w.Concrete.(MedicinalProductUndesirableEffectRead); ok {
	...
	case "RiskEvidenceSynthesis":
		if impl, ok := w.Concrete.(RiskEvidenceSynthesisRead); ok {
	...
	case "SubstanceSpecification":
		if impl, ok := w.Concrete.(SubstanceSpecificationRead); ok {
...
func (w Generic) Update(ctx context.Context, resource model.Resource) (update.Result[model.Resource], error) {
	...
	case r4.EffectEvidenceSynthesis:
		if impl, ok := w.Concrete.(EffectEvidenceSynthesisUpdate); ok {
	...
	case r4.MedicinalProduct:
		if impl, ok := w.Concrete.(MedicinalProductUpdate); ok {
	...
	case r4.MedicinalProductAuthorization:
		if impl, ok := w.Concrete.(MedicinalProductAuthorizationUpdate); ok {
	...
	case r4.MedicinalProductContraindication:
		if impl, ok := w.Concrete.(MedicinalProductContraindicationUpdate); ok {
	...
	case r4.MedicinalProductIndication:
		if impl, ok := w.Concrete.(MedicinalProductIndicationUpdate); ok {
	...
	case r4.MedicinalProductIngredient:
		if impl, ok := w.Concrete.(MedicinalProductIngredientUpdate); ok {
	...
	case r4.MedicinalProductInteraction:
		if impl, ok := w.Concrete.(MedicinalProductInteractionUpdate); ok {
	...
	case r4.MedicinalProductManufactured:
		if impl, ok := w.Concrete.(MedicinalProductManufacturedUpdate); ok {
	...
	case r4.MedicinalProductPackaged:
		if impl, ok := w.Concrete.(MedicinalProductPackagedUpdate); ok {
	...
	case r4.MedicinalProductPharmaceutical:
		if impl, ok := w.Concrete.(MedicinalProductPharmaceuticalUpdate); ok {
	...
	case r4.MedicinalProductUndesirableEffect:
		if impl, ok := w.Concrete.(MedicinalProductUndesirableEffectUpdate); ok {
	...
	case r4.RiskEvidenceSynthesis:
		if impl, ok := w.Concrete.(RiskEvidenceSynthesisUpdate); ok {
	...
	case r4.SubstanceSpecification:
		if impl, ok := w.Concrete.(SubstanceSpecificationUpdate); ok {
...
func (w Generic) Delete(ctx context.Context, resourceType string, id string) error {
	...
	case "EffectEvidenceSynthesis":
		if impl, ok := w.Concrete.(EffectEvidenceSynthesisDelete); ok {
	...
	case "MedicinalProduct":
		if impl, ok := w.Concrete.(MedicinalProductDelete); ok {
	...
	case "MedicinalProductAuthorization":
		if impl, ok := w.Concrete.(MedicinalProductAuthorizationDelete); ok {
	...
	case "MedicinalProductContraindication":
		if impl, ok := w.Concrete.(MedicinalProductContraindicationDelete); ok {
	...
	case "MedicinalProductIndication":
		if impl, ok := w.Concrete.(MedicinalProductIndicationDelete); ok {
	...
	case "MedicinalProductIngredient":
		if impl, ok := w.Concrete.(MedicinalProductIngredientDelete); ok {
	...
	case "MedicinalProductInteraction":
		if impl, ok := w.Concrete.(MedicinalProductInteractionDelete); ok {
	...
	case "MedicinalProductManufactured":
		if impl, ok := w.Concrete.(MedicinalProductManufacturedDelete); ok {
	...
	case "MedicinalProductPackaged":
		if impl, ok := w.Concrete.(MedicinalProductPackagedDelete); ok {
	...
	case "MedicinalProductPharmaceutical":
		if impl, ok := w.Concrete.(MedicinalProductPharmaceuticalDelete); ok {
	...
	case "MedicinalProductUndesirableEffect":
		if impl, ok := w.Concrete.(MedicinalProductUndesirableEffectDelete); ok {
	...
	case "RiskEvidenceSynthesis":
		if impl, ok := w.Concrete.(RiskEvidenceSynthesisDelete); ok {
	...
	case "SubstanceSpecification":
		if impl, ok := w.Concrete.(SubstanceSpecificationDelete); ok {
...
func (w Generic) Search(ctx context.Context, resourceType string, parameters search.Parameters, options search.Options) (search.Result[model.Resource], error) {
	...
	case "EffectEvidenceSynthesis":
		if impl, ok := w.Concrete.(EffectEvidenceSynthesisSearch); ok {
	...
	case "MedicinalProduct":
		if impl, ok := w.Concrete.(MedicinalProductSearch); ok {
	...
	case "MedicinalProductAuthorization":
		if impl, ok := w.Concrete.(MedicinalProductAuthorizationSearch); ok {
	...
	case "MedicinalProductContraindication":
		if impl, ok := w.Concrete.(MedicinalProductContraindicationSearch); ok {
	...
	case "MedicinalProductIndication":
		if impl, ok := w.Concrete.(MedicinalProductIndicationSearch); ok {
	...
	case "MedicinalProductIngredient":
		if impl, ok := w.Concrete.(MedicinalProductIngredientSearch); ok {
	...
	case "MedicinalProductInteraction":
		if impl, ok := w.Concrete.(MedicinalProductInteractionSearch); ok {
	...
	case "MedicinalProductManufactured":
		if impl, ok := w.Concrete.(MedicinalProductManufacturedSearch); ok {
	...
	case "MedicinalProductPackaged":
		if impl, ok := w.Concrete.(MedicinalProductPackagedSearch); ok {
	...
	case "MedicinalProductPharmaceutical":
		if impl, ok := w.Concrete.(MedicinalProductPharmaceuticalSearch); ok {
	...
	case "MedicinalProductUndesirableEffect":
		if impl, ok := w.Concrete.(MedicinalProductUndesirableEffectSearch); ok {
	...
	case "RiskEvidenceSynthesis":
		if impl, ok := w.Concrete.(RiskEvidenceSynthesisSearch); ok {
	...
	case "SubstanceSpecification":
		if impl, ok := w.Concrete.(SubstanceSpecificationSearch); ok {
